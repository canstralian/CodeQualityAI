...
class TestVisualization(unittest.TestCase):
    ...
    def test_visualize_code_quality_empty(self):
        ...
        self.assertEqual(len(fig.layout.annotations), 1)
        self.assertEqual(
            fig.layout.annotations[0].text, "No file analysis data available"
        )
        ...
        file_results = [
            ...
            },
            {
                ...
                "result": {
                    "score": 5.0,
                    "issues": [
                        {"type": "Missing docs", "line": 1},
                        {"type": "Complex code", "line": 5},
                    ],
                },
            },
            {
                ...
                "result": {
                    "score": 3.0,
                    "issues": [
                        {"type": "Security issue", "line": 1},
                        {"type": "Long line", "line": 10},
                    ],
                },
            },
        ]
