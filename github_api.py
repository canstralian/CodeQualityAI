...
class GitHubRepo:
        ...
        try:
            ...
            if response.status_code == 403 and 'X-RateLimit-Remaining' in response.headers and int(response.headers['X-RateLimit-Remaining']) == 0:
                ...
                if sleep_time > 300:  # More than 5 minutes wait time
                    handle_error("GitHub API rate limit exceeded. Please try again later or use a GitHub token.")
        ...
        while len(commits_data) < limit:
            ...
            for commit in page_data:
                ...
                commit_info = {
                    ...
                    'message': format_commit_message(commit.get('commit', {}).get('message', '')),
    ...
    def _get_large_file_content(self, file_path):
        ...
        try:
            ...
            # Get the blob
            blob_endpoint = f"/repos/{self.owner}/{self.repo_name}/git/blobs/{data['sha']}"
